...
//NOTE: for python 2.7, import_array return void,
//so we will need to use: void initOpenCVSwig...
int initOpenCVSwig()
{
    ...
    if(! wasInit)
    {
        wasInit = true;
		import_array();
		std::cout<<"initOpenCVSwig"<<std::endl; 
    }
    else{std::cout<<"initOpenCVSwig already init"<<std::endl; }
}
